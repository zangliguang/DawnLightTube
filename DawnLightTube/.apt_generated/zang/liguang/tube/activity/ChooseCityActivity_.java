    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        listview = ((ContactListViewImpl) hasViews.findViewById(zang.liguang.tube.R.id.listview));
        searchBox = ((EditText) hasViews.findViewById(zang.liguang.tube.R.id.input_search_query));
        mTitle = ((TextView) hasViews.findViewById(zang.liguang.tube.R.id.title));
        if (listview!= null) {
        ...
        {
            final TextView view = ((TextView) hasViews.findViewById(zang.liguang.tube.R.id.input_search_query));
            if (view!= null) {
