...
public final class WeatherItemView_
    extends WeatherItemView
    implements HasViews, OnViewChangedListener
{
    ...
    public WeatherItemView_(Context context) {
        super(context);
        init_();
    }

    public static WeatherItemView build(Context context) {
        WeatherItemView_ instance = new WeatherItemView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.item_weather, this);
