...
package zang.liguang.tube.wedget.viewimage.Indicators;

import java.util.ArrayList;

import zang.liguang.tube.R;
import zang.liguang.tube.wedget.viewimage.Tricks.InfinitePagerAdapter;
import zang.liguang.tube.wedget.viewimage.Tricks.ViewPagerEx;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener {
    ...
    /**
     * This value is from {@link com.tiger.quicknews.wedget.viewimage.Animations.daimajia.slider.library.SliderAdapter}
     * getRealCount() represent the indicator count that we should draw.
     */
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        int visibility = attributes.getInt(R.styleable.PagerIndicator_visibility,
        ...
        mUserSetSelectedIndicatorResId = attributes.getResourceId(
                R.styleable.PagerIndicator_selected_drawable,
                0);
        mUserSetUnSelectedIndicatorResId = attributes.getResourceId(
                R.styleable.PagerIndicator_unselected_drawable,
                0);
        ...
        mDefaultSelectedWidth = attributes.getDimension(R.styleable.PagerIndicator_selected_width,
                (int) pxFromDp(6));
        mDefaultSelectedHeight = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_selected_height, (int) pxFromDp(6));

        mDefaultUnSelectedWidth = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_unselected_width, (int) pxFromDp(6));
        mDefaultUnSelectedHeight = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_unselected_height, (int) pxFromDp(6));

        mSelectedGradientDrawable = new GradientDrawable();
        mUnSelectedGradientDrawable = new GradientDrawable();

        mPadding_left = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_padding_left,
                (int) pxFromDp(3));
        mPadding_right = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_padding_right,
                (int) pxFromDp(3));
        mPadding_top = attributes.getDimensionPixelSize(R.styleable.PagerIndicator_padding_top,
                (int) pxFromDp(0));
        mPadding_bottom = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_padding_bottom, (int) pxFromDp(0));
        ...
        mSelectedPadding_Left = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_selected_padding_left, (int) pxFromDp(3));
        mSelectedPadding_Right = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_selected_padding_right, (int) pxFromDp(3));
        mSelectedPadding_Top = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_selected_padding_top, (int) pxFromDp(0));
        mSelectedPadding_Bottom = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_selected_padding_bottom, (int) pxFromDp(0));

        mUnSelectedPadding_Left = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_unselected_padding_left, (int) pxFromDp(3));
        mUnSelectedPadding_Right = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_unselected_padding_right, (int) pxFromDp(3));
        mUnSelectedPadding_Top = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_unselected_padding_top, (int) pxFromDp(0));
        mUnSelectedPadding_Bottom = attributes.getDimensionPixelSize(
                R.styleable.PagerIndicator_unselected_padding_bottom, (int) pxFromDp(0));

        mSelectedLayerDrawable = new LayerDrawable(new Drawable[] {
                mSelectedGradientDrawable
        });
        mUnSelectedLayerDrawable = new LayerDrawable(new Drawable[] {
        ...
        setDefaultSelectedPadding(mSelectedPadding_Left, mSelectedPadding_Top,
                mSelectedPadding_Right, mSelectedPadding_Bottom, Unit.Px);
        setDefaultUnSelectedPadding(mUnSelectedPadding_Left, mUnSelectedPadding_Top,
                mUnSelectedPadding_Right, mUnSelectedPadding_Bottom, Unit.Px);
        attributes.recycle();
    }
    ...
    public void setDefaultSelectedPadding(float left, float top, float right, float bottom,
            Unit unit) {
        if (mUserSetSelectedIndicatorResId == 0) {
            if (unit == Unit.DP) {
                mSelectedLayerDrawable.setLayerInset(0,
    ...
    public void setDefaultUnSelectedPadding(float left, float top, float right, float bottom,
            Unit unit) {
        if (mUserSetSelectedIndicatorResId == 0) {
            if (unit == Unit.DP) {
                mUnSelectedLayerDrawable.setLayerInset(0,
    ...
    public void setViewPager(ViewPagerEx pager) {
        ...
        ((InfinitePagerAdapter) mPager.getAdapter()).getRealAdapter().registerDataSetObserver(
                dataChangeObserver);
    }
