...
package zang.liguang.tube.wedget.slidingmenu;

import java.util.ArrayList;
import java.util.List;

import zang.liguang.tube.wedget.slidingmenu.SlidingMenu.OnClosedListener;
import zang.liguang.tube.wedget.slidingmenu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    private void determineDrag(MotionEvent ev) {
        ...
        if (xDiff > (isMenuOpen() ? mTouchSlop / 2 : mTouchSlop) && xDiff > yDiff
                && thisSlideAllowed(dx)) {
            startDrag();
            mLastMotionX = x;
            mLastMotionY = y;
