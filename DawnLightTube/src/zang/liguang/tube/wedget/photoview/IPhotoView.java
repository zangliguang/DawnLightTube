...
public interface IPhotoView {
     ...
     * 
     * @param rotationDegree - Degree to rotate PhotoView to, should be in range
     *            0 to 360
     */
     ...
     * Enables rotation via PhotoView internal functions.
     * 
     * @param rotationDegree - Degree to rotate PhotoView by, should be in range
     *            0 to 360
     */
     ...
     * 
     * @param newOnDoubleTapListener custom OnDoubleTapListener to be set on
     *            ImageView
     */
