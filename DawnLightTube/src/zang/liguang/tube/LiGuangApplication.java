...
import zang.liguang.tube.db.DatabaseHelper;
import zang.liguang.tube.db.SQLHelper;
...
@EApplication
public class LiGuangApplication extends Application
{
	private static LiGuangApplication mAppApplication;
	...
	public void onTerminate()
	{
	 ...
	 /** 获取Application */
    public static LiGuangApplication getApp() {
    ...
    public DatabaseHelper getDatabaseHelper() {
    	if (databaseHelper == null)
    		databaseHelper = new DatabaseHelper(mAppApplication);
